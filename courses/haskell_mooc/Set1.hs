...
distance x1 y1 x2 y2 = sqrt (xDistanceSquared + yDistanceSquared)
  where xDistanceSquared = (x1 - x2) ^ 2
        yDistanceSquared = (y1 - y2) ^ 2
...
-- Type sig commented out because it has to be some sort of IO type
eeny :: Integer -> String
